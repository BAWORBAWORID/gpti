/*
    Author: yandricr
    API: https://gpti.baworzz.my.id/api
    Docs: https://gpti.baworzz.my.id/
*/
...
const gpti = {
    gpt: ({
       ...
       type = "json",
        ...
        const url = "https://gpti.baworzz.my.id/api/gpti";
        const js = {
    ...
    dalle: ({
        ...
        const url = "https://gpti.baworzz.my.id/api/dalleai";
        const js = {
    ...
    lexica: ({
        ...
        const url = "https://gpti.baworzz.my.id/api/lexicaai";
        const js = {
    ...
    prodia: ({
        ...
        const url = "https://gpti.baworzz.my.id/api/prodiaai";
        const js = {
            prompt: (prompt != undefined && prompt.toString().trim().length > 0 ? prompt.toString() : ""),
